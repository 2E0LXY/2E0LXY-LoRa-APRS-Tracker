...
bool loadConfig() {
    ...
    Config.audio.enabled      = doc["audio"]["enabled"]   | true;
    Config.audio.volume       = doc["audio"]["volume"]    | 70;
...
bool saveConfig() {
    ...
    doc["audio"]["enabled"]    = Config.audio.enabled;
    doc["audio"]["volume"]     = Config.audio.volume;
